...
$!
$! LAVDRIVER.COM
$! Compile and link procedure for LAVDRIVER.EXE.
$!
$! Usage:
$!
$!   @LAVDRIVER [DEBUG]
...
$ CC/FLOAT=IEEE/EXTERN=STRICT/POINTER_SIZE=32-
        'DEBUG_CC_OPT'-
	/WARN=(ENABLE=(defunct,obsolescent,questcode,unusedtop),-
	       DISABLE=(boolexprconst,unreachcode))-
        /LIS=LIS$:LAVDRIVER/MACHINE_CODE-
        /OBJ=OBJ$:LAVDRIVER-
                SRC$:LAVDRIVER -
...
$ LINK/USERLIB=PROC/NATIVE_ONLY/BPAGE=14/SECTION/REPLACE-
        ...
        /SHARE=EXE$:LAVDRIVER.EXE-		! Driver image
        /DSF=EXE$:LAVDRIVER.DSF-		! Debug symbol file
        /SYMBOL=EXE$:LAVDRIVER.STB-		! Symbol table
        /MAP=MAP$:LAVDRIVER.MAP/FULL/CROSS -	! Map listing
                SYS$INPUT:/OPTIONS
!
